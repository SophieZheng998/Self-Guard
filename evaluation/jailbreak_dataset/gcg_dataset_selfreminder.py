...
def main(args):
    ...
    for example in tqdm(dataset):
        ...
        result = nanogcg.run(target_model, target_tokenizer, message, target, config, defense_type="selfreminder")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="Qwen3-8B/") # output_responses/safety-strongreject-unaligned/
