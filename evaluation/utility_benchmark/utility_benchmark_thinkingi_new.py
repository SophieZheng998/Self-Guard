...
def main():
    ...
    parser.add_argument("--examples", type=int, help="Number of examples to use (overrides default)", default=None)
    ...
    parser.add_argument("--output_dir", type=str, default="./eval_results/thinkingi/")
    ...
    parser.add_argument("--steering_strength", type=float, default=-150)
    ...
    parser.add_argument("--template", type=str, default="thinkingi_new_qwen")
