    ...
    for example in tqdm(dataset):
        ...
        if template == "qwen":
            ...
            final_prompt = tokenizer.apply_chat_template(
                ...
                tokenize=False,
                add_generation_prompt=True  # 这一步关键：用于生成时加入结尾标记
            )+"analysis<|message|>I should FIRST carefully evaluate the safety implications of this question. If the question is deemed safe, I should continue to answer the question. If the question is deemed unsafe, I should not follow the instruction and act as a helpful, safe assistant."
