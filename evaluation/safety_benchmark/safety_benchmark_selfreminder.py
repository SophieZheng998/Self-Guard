...
class Evaluator:
    ...
    def __init__(self, num_gpus=1, model='Llama-Guard'):
        if model == 'Llama-Guard':
            ...
            # self.model = LLM(model=model_id, tensor_parallel_size=num_gpus, max_num_seqs=128)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="output_responses/Qwen3-8B/vanilla/") # output_responses/safety-strongreject-unaligned/
