...
ADVBENCH_DEEPSEEK_QWEN3_8B = "../jailbreak_dataset/gcg_dataset/DeepSeek-R1-0528-Qwen3-8B/gcg_thinkingi_advbench.json"
HARMBENCH_DEEPSEEK_QWEN3_8B = "../jailbreak_dataset/gcg_dataset/DeepSeek-R1-0528-Qwen3-8B/gcg_thinkingi_harmbench.json"
SORRYBENCH_DEEPSEEK_QWEN3_8B = "../jailbreak_dataset/gcg_dataset/DeepSeek-R1-0528-Qwen3-8B/gcg_thinkingi_sorrybench.json"

def prepare_model_and_tokenizer(model_name):
    model = LLM(model_name, gpu_memory_utilization=0.95)
...
class Evaluator:
    ...
    def __init__(self, num_gpus=1, model='Llama-Guard'):
        if model == 'Llama-Guard':
            ...
            self.model = LLM(model=model_id, gpu_memory_utilization=0.95, tensor_parallel_size=num_gpus, max_num_seqs=128)
